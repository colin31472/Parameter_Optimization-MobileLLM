...
checkpoint_path = 'checkpoints/Deep_Thinking_model_step_10.pt'
...
if load_from_checkpoint:
    try:
        ...
        print(f"Resuming from epoch {start_epoch} with best eval loss: {best_eval_loss}")
...
print(f"WikiText-103 test Perplexity: {test_perplexity:.2f}")
